        ...
        for i in range(3):
            ...
            if Guess == Q1I[4]:
                if i == 0:
                    ...
                    if i == 2:
                        input(f"Sorry that is incorrect, the correct answer was {Q1I[4]} due to getting the question wrong three times in a row it will be skipped, please press enter to continue")
                        print("\n" * 20)
                    else:
        ...
        for i in range(3):
            ...
            if Guess == Q2I[4]:
                if i == 0:
                    ...
                    if i == 2:
                        input("Sorry that is incorrect, the correct answer was",Q2I[4],"due to getting the question wrong three times in a row it will be skipped, please press enter to continue")
                        print("\n" * 20)
                    else:
                        input("Sorry that is incorrect, please press enter to try again")
                        print("\n" * 20)
        ...
        for i in range(3):
            ...
            if Guess == Q3I[4]:
                if i == 0:
                    ...
                    if i == 2:
                        input("Sorry that is incorrect, the correct answer was",Q3I[4],"due to getting the question wrong three times in a row it will be skipped, please press enter to continue")
                        print("\n" * 20)
                    else:
                        input("Sorry that is incorrect, please press enter to try again")
                        print("\n" * 20)
